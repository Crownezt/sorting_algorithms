 ...
 *                   list of integrs with the node ahead of it.
 * @list: A points to the head of a doubly-linked list of integrs.
 * @tail: A points to the tail of the doubly-linked list.
 * @shaker: A points to the current swapping node of the cocktail shaker algo.
 */
void swap_node_ahead(listint_t **list, listint_t **tail, listint_t **shaker)
{
 ...
 *                    list of integrs with the node behind it.
 * @list: A points to the head of a doubly-linked list of integrs.
 * @tail: A points to the tail of the doubly-linked list.
 * @shaker: A points to the current swapping node of the cocktail shaker algo.
 */
 ...
 *                      ascendn order using the cocktail shaker algorthm
 * @list: A points to the head of a listint_t doubly-linked list.
 */
void cocktail_sort_list(listint_t **list)
{
